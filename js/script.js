window.addEventListener('DOMContentLoaded', function () {
    ...
    addBook.addEventListener('click', function () {
        openModal();
        clearForm();
        formHeader.innerHTML = 'Добавить книгу';
    ...
    //Валидация формы при добавлении/сохранении книги
...
//Сохраняем книгу с отредактированными данными
...
// Подтягиваем данные книги, которую хотим отредактировать
